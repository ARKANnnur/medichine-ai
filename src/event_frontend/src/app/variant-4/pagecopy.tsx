...
export default function Home() {
  ...
  type Lokasi = { lat: number; lon: number };
  type ApotekFromCanister = { nama: string; alamat: string; lokasi: Lokasi };
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-grow">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-4 text-lg text-gray-800 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-200 outline-none"
                />
              </div>
              <button
        ...
        {searchResults.length > 0 && (
          <div className="animate-fade-in-up">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Ditemukan {searchResults.length} apotek dengan obat yang Anda cari
              </p>
            </div>
                ...
                >
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold text-blue-600">
                          Rp {item.obat.harga.toLocaleString()}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center text-gray-600 mb-4">
                      ...
                      <span className="text-sm">{item.apotek}</span>
                    </div>
